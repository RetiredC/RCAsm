...
class CuSMVersion(object):
    ...
    SMCodeNameDict = { 35:'Kepler',  37:'Kepler',
                       ...
                       89:'Adalovelace', 90:'Hopper', 120:'Blackwell'}
    ...
    def __init__(self, version):
        self.mVersion = CuSMVersion.parseVersionNumber(version)
    
        self.__mMajor = self.mVersion // 10
        self.__mMinor = self.mVersion % 10
        if self.__mMajor<=6:
    ...
    def __str__(self):
        return 'CuSMVersion(%d)'%self.mVersion
